                ...
                <tr>
                    <td><table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><a onmouseover="changeImages( /*CMP*/'online',/*URL*/'${resourcesPath}/images/products/frameworks/online-over.gif');return true" onmouseout="changeImages( /*CMP*/'online',/*URL*/'${resourcesPath}/images/products/frameworks/online.gif');return true" href="${vc.rootUrl}/products/frameworks/try"><img src="${resourcesPath}/images/products/frameworks/online.gif" alt="" name="online" height="24" width="74" border="0"></a></td>
                                <td><a onmouseover="changeImages( /*CMP*/'fact',/*URL*/'${resourcesPath}/images/products/frameworks/fact-over.gif');return true" onmouseout="changeImages( /*CMP*/'fact',/*URL*/'${resourcesPath}/images/products/frameworks/fact.gif');return true" href="${resourcesPath}/nefs-fact-sheet.pdf"><img src="${resourcesPath}/images/products/frameworks/fact.gif" alt="" name="fact" height="24" width="71" border="0"></a></td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
