                ...
                <tr>
                    <td><table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><a onmouseover="changeImages( /*CMP*/'online',/*URL*/'${resourcesPath}/images/products/frameworks/online-over.gif');return true" onmouseout="changeImages( /*CMP*/'online',/*URL*/'${resourcesPath}/images/products/frameworks/online.gif');return true" href="${vc.rootUrl}/sampler" target="sampler"><img src="${resourcesPath}/images/products/frameworks/online.gif" alt="" name="online" height="24" width="74" border="0"></a></td>
