                ...
                <tr>
                    <td><table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><a onmouseover="changeImages( /*CMP*/'security',/*URL*/'${resourcesPath}/images/products/frameworks/security-over.gif');return true" onmouseout="changeImages( /*CMP*/'security',/*URL*/'${resourcesPath}/images/products/frameworks/security.gif');return true" href="#"><img src="${resourcesPath}/images/products/frameworks/security.gif" alt="" name="security" height="24" width="59" border="0"></a></td>
