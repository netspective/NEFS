...
<ul>
    ...
    <li>They are notoriously difficult to extend because they are typically designed for special-purpose jobs.
    <li>They are expensive to create and maintain and require engineering attention which is taken away from business requirements.
    <li>Programmers often end up wasting time on infrastructure issues instead of issues that directly affect end-users.
</ul>
