...
<ul>
    <li>You don't have "one throat to choke" when there's a problem. Free tools lack appropriate support so you won't be able to make a phone call or send an e-mail to a single source (like us) for support.
    <li>None of these free products match NEF from a feature or functionality perspective (to compare, see our <a href="${servletPath}/products/frameworks/features">Features</a>).
