			...
			<span class="disclaimer">
				...
				<table cellpadding="0" cellspacing="0" border="0" width="600">
					<tbody><tr>
						...
						<td><a href="${servletPath}/buy" onmouseout="changeImages( /*CMP*/'home_9',/*URL*/'${resourcesPath}/images/header/buy.gif');return true" onmouseover="changeImages( /*CMP*/'home_9',/*URL*/'${resourcesPath}/images/header/buy-over.gif');return true"><img alt="" border="0" height="17" width="30" src="${resourcesPath}/images/header/buy.gif" name="home_9"></a></td>
