			...
			<span class="disclaimer">
				...
				<table cellpadding="0" cellspacing="0" border="0" width="600">
					<tbody><tr>
						...
						<td><a href="${servletPath}/products/frameworks/try" onmouseout="changeImages( /*CMP*/'home_8',/*URL*/'${resourcesPath}/images/header/downloads.gif');return true" onmouseover="changeImages( /*CMP*/'home_8',/*URL*/'${resourcesPath}/images/header/downloads-over.gif');return true"><img alt="" border="0" height="17" width="65" src="${resourcesPath}/images/header/downloads.gif" name="home_8"></a></td>
