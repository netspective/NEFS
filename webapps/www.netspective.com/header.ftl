			...
			<span class="disclaimer">
							...
							<table cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									<td>
										<table cellpadding="0" cellspacing="0" border="0">
											<tbody><tr>
												<td><a href="${servletPath}/sales"><img border="0" alt="" height="16" width="365" src="${resourcesPath}/images/header/ad-line.gif"></a></td>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="600">
					<tbody><tr>
						...
						<td><a href="${servletPath}/sales" onmouseout="changeImages( /*CMP*/'home_9',/*URL*/'${resourcesPath}/images/header/buy.gif');return true" onmouseover="changeImages( /*CMP*/'home_9',/*URL*/'${resourcesPath}/images/header/buy-over.gif');return true"><img alt="" border="0" height="17" width="30" src="${resourcesPath}/images/header/buy.gif" name="home_9"></a></td>
