			...
			<span class="disclaimer">
				...
				<table cellpadding="0" cellspacing="0" border="0" width="600">
					<tbody><tr>
						...
						<td><a href="${vc.servletRootUrl}company" onmouseout="changeImages( /*CMP*/'home_15',/*URL*/'${resourcesPath}/images/header/company.gif');return true" onmouseover="changeImages( /*CMP*/'home_15',/*URL*/'${resourcesPath}/images/header/company-over.gif');return true"><img alt="" border="0" height="17" width="58" src="${resourcesPath}/images/header/company.gif" name="home_15"></a></td>
