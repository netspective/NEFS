...
<table width="600" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td valign=top><img src="${resourcesPath}/images/home/NEFS.gif" width="306" height="86" alt=""><table border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody><tr>
                    <td><table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tbody><tr>
                                <td><a onmouseover="changeImages( /*CMP*/'home_28',/*URL*/'${resourcesPath}/images/home/what-over.gif');return true" onmouseout="changeImages( /*CMP*/'home_28',/*URL*/'${resourcesPath}/images/home/what.gif');return true" href="${servletPath}/products/frameworks/suite/what-it-does"><img name="home_28" src="${resourcesPath}/images/home/what.gif" width="116" height="24" border="0" alt=""></a></td>
                            </tr>
                            <tr>
        ...
        <ul class="check-list" style="margin-bottom:0px; ">
            ...
            <li class="home-page">Create beautiful UIs that impress users</li>
...
<table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <font color="#666666" style="font-size: 9pt;">
            <font style="font-size:10pt"><b>Is your information architecture  keeping pace with your business goals?</b></font>
            <br>Our <a href="services/neap">Enterprise
            Architecture Planning</a> Turn-key Service can quickly help you reduce duplication of functions across apps and eliminate
            redundant data across silos of information.
        </font>
        </td>
    </tr>

    <tr>
        <td><img src="${resourcesPath}/images/home/home_28.gif" width="600" height="12" alt=""></td>
    </tr>
    <tr>
        <td>
            <table border="0" cellspacing="0" cellpadding="0">
        	...
        	<@panel heading="NEFS Technology Highlights" skin="tabbed-full">
                <@reportTable
                        data=[
			              ...
			              ["Implemented Patterns", "<font color='#666666'>MVC, MVP, Command, Observer, State, Lazy Init, others.</font>"]                          
                          ]/>
        	</@panel>
        </td>
    </tr>
    <tr>
        <td><img src="${resourcesPath}/images/home/home_40.gif" width="600" height="13" alt=""></td>
