...
public final class PersonRelationshipTable
{
    ...
    public PersonRelationshipTable(Table table)
    {
    ...
    public final PersonRelationshipTable.Record createChildLinkedByParentId(PersonTable.Record parentRecord)
    {
        return new PersonRelationshipTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final PersonRelationshipTable.Record createRecord()
    {
        return new PersonRelationshipTable.Record(table.createRow());
    }
    ...
    public final PersonRelationshipTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    /**
     * Parent reference: ParentForeignKey Sources: Person_Relationship.parent_id;
     *  Referenced Columns: Person.person_id
     */
    public final PersonRelationshipTable.Records getParentRecordsByParentId(PersonTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final PersonRelationshipTable.Record getRecord(Row row)
    {
        return new PersonRelationshipTable.Record(row);
    }
    
    public final PersonRelationshipTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.Long systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new PersonRelationshipTable.Record(row) : null;
        return result;
    }
    
    public final PersonRelationshipTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.PersonRelationship getValues()
        {
            return getValues(new auto.dal.db.vo.impl.PersonRelationshipVO());
        }
        
        public final auto.dal.db.vo.PersonRelationship getValues(auto.dal.db.vo.PersonRelationship valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.PersonRelationship valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final PersonRelationshipTable.Record get(int i)
        {
