...
public final class PersonRoleTable
{
    ...
    public static final int ACCESSORID_BY_ROLE_NAME_ID_EQUALITY = 7;
    ...
    public static final int COLINDEX_ROLE_NAME_ID = 5;
    
    public PersonRoleTable(Table table)
    {
        ...
        roleNameIdForeignKey = table.getColumns().get(COLINDEX_ROLE_NAME_ID).getForeignKey();
    }
    
    public final PersonRoleTable.Record createChildLinkedByPersonId(PersonTable.Record parentRecord)
    {
        return new PersonRoleTable.Record(table.createRow(personIdForeignKey, parentRecord.getRow()));
    }
    
    public final PersonRoleTable.Record createRecord()
    {
        return new PersonRoleTable.Record(table.createRow());
    }
    ...
    public final PersonRoleTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    /**
     * Parent reference: ParentForeignKey Sources: Person_Role.person_id;
     *  Referenced Columns: Person.person_id
     */
    public final PersonRoleTable.Records getParentRecordsByPersonId(PersonTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final PersonRoleTable.Record getRecord(Row row)
    {
        return new PersonRoleTable.Record(row);
    }
    
    public final PersonRoleTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.String systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new PersonRoleTable.Record(row) : null;
        return result;
    }
    
    public final PersonRoleTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final GuidTextColumn getRoleNameIdColumn()
    {
        return (GuidTextColumn)table.getColumns().get(COLINDEX_ROLE_NAME_ID);
    }
    
    public final ForeignKey getRoleNameIdForeignKey()
    {
        return roleNameIdForeignKey;
    }
    ...
    private ForeignKey roleNameIdForeignKey;
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.PersonRole getValues()
        {
            return getValues(new auto.dal.db.vo.impl.PersonRoleVO());
        }
        
        public final auto.dal.db.vo.PersonRole getValues(auto.dal.db.vo.PersonRole valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.PersonRole valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final PersonRoleTable.Record get(int i)
        {
