...
public final class StudyPersonRelationshipTable
{
    ...
    public StudyPersonRelationshipTable(Table table)
    {
    ...
    public final StudyPersonRelationshipTable.Record createChildLinkedByParentId(StudyTable.Record parentRecord)
    {
        return new StudyPersonRelationshipTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final StudyPersonRelationshipTable.Record createRecord()
    {
        return new StudyPersonRelationshipTable.Record(table.createRow());
    }
    ...
    public final StudyPersonRelationshipTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
     ...
     *  StudyPerson_Relationship.parent_id; Referenced Columns: Study.study_id
     */
    public final StudyPersonRelationshipTable.Records getParentRecordsByParentId(StudyTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final StudyPersonRelationshipTable.Record getRecord(Row row)
    {
        return new StudyPersonRelationshipTable.Record(row);
    }
    
    public final StudyPersonRelationshipTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.Long systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new StudyPersonRelationshipTable.Record(row) : null;
        return result;
    }
    
    public final StudyPersonRelationshipTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.StudyPersonRelationship getValues()
        {
            return getValues(new auto.dal.db.vo.impl.StudyPersonRelationshipVO());
        }
        
        public final auto.dal.db.vo.StudyPersonRelationship getValues(auto.dal.db.vo.StudyPersonRelationship valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.StudyPersonRelationship valueObject)
        {
    ...
    public final class Records
    {
        ...
        public Records(StudyTable.Record parentRecord, Rows rows)
        {
            this(rows);
            this.parentRecord = parentRecord;
        }
        
        public final StudyPersonRelationshipTable.Record get(int i)
        {
        ...
        private StudyTable.Record parentRecord;
        private Rows rows;
    }
}