...
public final class OrgNoteTable
{
    ...
    public OrgNoteTable(Table table)
    {
    ...
    public final OrgNoteTable.Record createChildLinkedByParentId(OrgTable.Record parentRecord)
    {
        return new OrgNoteTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final OrgNoteTable.Record createRecord()
    {
        return new OrgNoteTable.Record(table.createRow());
    }
    ...
    public final OrgNoteTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    /**
     * Parent reference: ParentForeignKey Sources: Org_Note.parent_id; Referenced
     *  Columns: Org.org_id
     */
    public final OrgNoteTable.Records getParentRecordsByParentId(OrgTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final OrgNoteTable.Record getRecord(Row row)
    {
        return new OrgNoteTable.Record(row);
    }
    
    public final OrgNoteTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.String systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new OrgNoteTable.Record(row) : null;
        return result;
    }
    
    public final OrgNoteTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.OrgNote getValues()
        {
            return getValues(new auto.dal.db.vo.impl.OrgNoteVO());
        }
        
        public final auto.dal.db.vo.OrgNote getValues(auto.dal.db.vo.OrgNote valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.OrgNote valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final OrgNoteTable.Record get(int i)
        {
