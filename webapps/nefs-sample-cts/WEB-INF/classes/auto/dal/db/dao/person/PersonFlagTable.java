...
public final class PersonFlagTable
{
    ...
    public static final int ACCESSORID_BY_FLAG_ID_EQUALITY = 7;
    ...
    public static final int COLINDEX_FLAG_ID = 5;
    
    public PersonFlagTable(Table table)
    {
        ...
        flagIdForeignKey = table.getColumns().get(COLINDEX_FLAG_ID).getForeignKey();
    }
    
    public final PersonFlagTable.Record createChildLinkedByParentId(PersonTable.Record parentRecord)
    {
        return new PersonFlagTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final PersonFlagTable.Record createRecord()
    {
        return new PersonFlagTable.Record(table.createRow());
    }
    ...
    public final QueryDefnSelect getAccessorByFlagIdEquality()
    {
        return accessors.get(ACCESSORID_BY_FLAG_ID_EQUALITY);
    }
    ...
    public final PersonFlagTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    public final EnumerationIdRefColumn getFlagIdColumn()
    {
        return (EnumerationIdRefColumn)table.getColumns().get(COLINDEX_FLAG_ID);
    }
    
    public final ForeignKey getFlagIdForeignKey()
    {
        return flagIdForeignKey;
    }
    ...
    /**
     * Parent reference: ParentForeignKey Sources: Person_Flag.parent_id;
     *  Referenced Columns: Person.person_id
     */
    public final PersonFlagTable.Records getParentRecordsByParentId(PersonTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final PersonFlagTable.Record getRecord(Row row)
    {
        return new PersonFlagTable.Record(row);
    }
    
    public final PersonFlagTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.String systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new PersonFlagTable.Record(row) : null;
        return result;
    }
    
    public final PersonFlagTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    private ForeignKey flagIdForeignKey;
    ...
    public final class Record
    {
        ...
        public final EnumerationIdRefColumn.EnumerationIdRefValue getFlagId()
        {
            return (EnumerationIdRefColumn.EnumerationIdRefValue)values.getByColumnIndex(COLINDEX_FLAG_ID);
        }
        ...
        public final auto.dal.db.vo.PersonFlag getValues()
        {
            return getValues(new auto.dal.db.vo.impl.PersonFlagVO());
        }
        
        public final auto.dal.db.vo.PersonFlag getValues(auto.dal.db.vo.PersonFlag valueObject)
        {
            ...
            valueObject.setFlagId((java.lang.Integer) values.getByColumnIndex(COLINDEX_FLAG_ID).getValue());
            return valueObject;
        }
        ...
        public final void setFlagId(com.netspective.commons.value.Value value)
        {
            getFlagId().copyValueByReference(value);
        }
        ...
        public final void setValues(auto.dal.db.vo.PersonFlag valueObject)
        {
            ...
            values.getByColumnIndex(COLINDEX_FLAG_ID).setValue(valueObject.getFlagId());
        }
