...
public final class PersonContactTable
{
    ...
    public static final int ACCESSORID_BY_INDEX_PERSON_CONTACT_UNQ_EQUALITY = 14;
    ...
    public PersonContactTable(Table table)
    {
    ...
    public final PersonContactTable.Record createChildLinkedByParentId(PersonTable.Record parentRecord)
    {
        return new PersonContactTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final PersonContactTable.Record createRecord()
    {
        return new PersonContactTable.Record(table.createRow());
    }
    ...
    public final QueryDefnSelect getAccessorByIndexPersonContactUnqEquality()
    {
        return accessors.get(ACCESSORID_BY_INDEX_PERSON_CONTACT_UNQ_EQUALITY);
    }
    ...
    public final PersonContactTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    /**
     * Parent reference: ParentForeignKey Sources: Person_Contact.parent_id;
     *  Referenced Columns: Person.person_id
     */
    public final PersonContactTable.Records getParentRecordsByParentId(PersonTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final PersonContactTable.Record getRecord(Row row)
    {
        return new PersonContactTable.Record(row);
    }
    
    public final PersonContactTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.String systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new PersonContactTable.Record(row) : null;
        return result;
    }
    
    public final PersonContactTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.PersonContact getValues()
        {
            return getValues(new auto.dal.db.vo.impl.PersonContactVO());
        }
        
        public final auto.dal.db.vo.PersonContact getValues(auto.dal.db.vo.PersonContact valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.PersonContact valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final PersonContactTable.Record get(int i)
        {
