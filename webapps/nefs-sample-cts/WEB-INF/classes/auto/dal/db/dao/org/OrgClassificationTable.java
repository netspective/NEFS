...
public final class OrgClassificationTable
{
    ...
    public OrgClassificationTable(Table table)
    {
    ...
    {
        return new OrgClassificationTable.Record(table.createRow());
    }
    ...
    public final OrgClassificationTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    public final EnumerationIdRefColumn getOrgTypeIdColumn()
    {
        return (EnumerationIdRefColumn)table.getColumns().get(COLINDEX_ORG_TYPE_ID);
    }
    
    public final ForeignKey getOrgTypeIdForeignKey()
    {
    ...
    public final OrgClassificationTable.Record getRecord(Row row)
    {
        return new OrgClassificationTable.Record(row);
    }
    
    public final OrgClassificationTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.String systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new OrgClassificationTable.Record(row) : null;
        return result;
    }
    
    public final OrgClassificationTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.OrgClassification getValues()
        {
            return getValues(new auto.dal.db.vo.impl.OrgClassificationVO());
        }
        
        public final auto.dal.db.vo.OrgClassification getValues(auto.dal.db.vo.OrgClassification valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.OrgClassification valueObject)
        {
