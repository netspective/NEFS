...
public final class OrgIndustryTable
{
    ...
    public static final int ACCESSORID_BY_INDUSTRY_TYPE_ID_EQUALITY = 7;
    public static final int ACCESSORID_BY_INDUSTRY_TYPE_EQUALITY = 8;
    ...
    public static final int COLINDEX_INDUSTRY_TYPE_ID = 5;
    public static final int COLINDEX_INDUSTRY_TYPE = 6;
    
    public OrgIndustryTable(Table table)
    {
        ...
        industryTypeIdForeignKey = table.getColumns().get(COLINDEX_INDUSTRY_TYPE_ID).getForeignKey();
    }
    
    public final OrgIndustryTable.Record createChildLinkedByOrgId(OrgTable.Record parentRecord)
    {
        return new OrgIndustryTable.Record(table.createRow(orgIdForeignKey, parentRecord.getRow()));
    }
    
    public final OrgIndustryTable.Record createRecord()
    {
        return new OrgIndustryTable.Record(table.createRow());
    }
    ...
    public final QueryDefnSelect getAccessorByIndustryTypeEquality()
    {
        return accessors.get(ACCESSORID_BY_INDUSTRY_TYPE_EQUALITY);
    }
    
    public final QueryDefnSelect getAccessorByIndustryTypeIdEquality()
    {
        return accessors.get(ACCESSORID_BY_INDUSTRY_TYPE_ID_EQUALITY);
    }
    ...
    public final OrgIndustryTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    public final TextColumn getIndustryTypeColumn()
    {
        return (TextColumn)table.getColumns().get(COLINDEX_INDUSTRY_TYPE);
    }
    
    public final EnumerationIdRefColumn getIndustryTypeIdColumn()
    {
        return (EnumerationIdRefColumn)table.getColumns().get(COLINDEX_INDUSTRY_TYPE_ID);
    }
    
    public final ForeignKey getIndustryTypeIdForeignKey()
    {
        return industryTypeIdForeignKey;
    }
    ...
    /**
     * Parent reference: ParentForeignKey Sources: Org_Industry.org_id; Referenced
     *  Columns: Org.org_id
     */
    public final OrgIndustryTable.Records getParentRecordsByOrgId(OrgTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final OrgIndustryTable.Record getRecord(Row row)
    {
        return new OrgIndustryTable.Record(row);
    }
    
    public final OrgIndustryTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.String systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new OrgIndustryTable.Record(row) : null;
        return result;
    }
    
    public final OrgIndustryTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    private ForeignKey industryTypeIdForeignKey;
    ...
    public final class Record
    {
        ...
        public final TextColumn.TextColumnValue getIndustryType()
        {
            return (TextColumn.TextColumnValue)values.getByColumnIndex(COLINDEX_INDUSTRY_TYPE);
        }
        
        public final EnumerationIdRefColumn.EnumerationIdRefValue getIndustryTypeId()
        {
            return (EnumerationIdRefColumn.EnumerationIdRefValue)values.getByColumnIndex(COLINDEX_INDUSTRY_TYPE_ID);
        }
        ...
        public final auto.dal.db.vo.OrgIndustry getValues()
        {
            return getValues(new auto.dal.db.vo.impl.OrgIndustryVO());
        }
        
        public final auto.dal.db.vo.OrgIndustry getValues(auto.dal.db.vo.OrgIndustry valueObject)
        {
            ...
            valueObject.setIndustryTypeId((java.lang.Integer) values.getByColumnIndex(COLINDEX_INDUSTRY_TYPE_ID).getValue());
            valueObject.setIndustryType((java.lang.String) values.getByColumnIndex(COLINDEX_INDUSTRY_TYPE).getValue());
            return valueObject;
        }
        ...
        public final void setIndustryType(com.netspective.commons.value.Value value)
        {
            getIndustryType().copyValueByReference(value);
        }
        
        public final void setIndustryTypeId(com.netspective.commons.value.Value value)
        {
            getIndustryTypeId().copyValueByReference(value);
        }
        ...
        public final void setValues(auto.dal.db.vo.OrgIndustry valueObject)
        {
            ...
            values.getByColumnIndex(COLINDEX_INDUSTRY_TYPE_ID).setValue(valueObject.getIndustryTypeId());
            values.getByColumnIndex(COLINDEX_INDUSTRY_TYPE).setValue(valueObject.getIndustryType());
        }
    ...
    public final class Records
    {
        ...
        public final OrgIndustryTable.Record get(int i)
        {
