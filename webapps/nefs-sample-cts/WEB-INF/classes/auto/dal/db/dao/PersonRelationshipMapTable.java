...
public final class PersonRelationshipMapTable
{
    ...
    public PersonRelationshipMapTable(Table table)
    {
    ...
    public final PersonRelationshipMapTable.Record createRecord()
    {
        return new PersonRelationshipMapTable.Record(table.createRow());
    }
    ...
    public final PersonRelationshipMapTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    public final PersonRelationshipMapTable.Record getRecord(Row row)
    {
        return new PersonRelationshipMapTable.Record(row);
    }
    
    public final PersonRelationshipMapTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.String systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new PersonRelationshipMapTable.Record(row) : null;
        return result;
    }
    
    public final PersonRelationshipMapTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.PersonRelationshipMap getValues()
        {
            return getValues(new auto.dal.db.vo.impl.PersonRelationshipMapVO());
        }
        
        public final auto.dal.db.vo.PersonRelationshipMap getValues(auto.dal.db.vo.PersonRelationshipMap valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.PersonRelationshipMap valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final PersonRelationshipMapTable.Record get(int i)
        {
