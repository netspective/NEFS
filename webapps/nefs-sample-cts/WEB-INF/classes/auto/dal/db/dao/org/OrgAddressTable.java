...
public final class OrgAddressTable
{
    ...
    public static final int ACCESSORID_BY_INDEX_ORG_ADDRESS_UNQ_EQUALITY = 18;
    ...
    public OrgAddressTable(Table table)
    {
    ...
    public final OrgAddressTable.Record createChildLinkedByParentId(OrgTable.Record parentRecord)
    {
        return new OrgAddressTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final OrgAddressTable.Record createRecord()
    {
        return new OrgAddressTable.Record(table.createRow());
    }
    ...
    public final QueryDefnSelect getAccessorByIndexOrgAddressUnqEquality()
    {
        return accessors.get(ACCESSORID_BY_INDEX_ORG_ADDRESS_UNQ_EQUALITY);
    }
    ...
    public final OrgAddressTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    /**
     * Parent reference: ParentForeignKey Sources: Org_Address.parent_id;
     *  Referenced Columns: Org.org_id
     */
    public final OrgAddressTable.Records getParentRecordsByParentId(OrgTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final OrgAddressTable.Record getRecord(Row row)
    {
        return new OrgAddressTable.Record(row);
    }
    
    public final OrgAddressTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.String systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new OrgAddressTable.Record(row) : null;
        return result;
    }
    
    public final OrgAddressTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.OrgAddress getValues()
        {
            return getValues(new auto.dal.db.vo.impl.OrgAddressVO());
        }
        
        public final auto.dal.db.vo.OrgAddress getValues(auto.dal.db.vo.OrgAddress valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.OrgAddress valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final OrgAddressTable.Record get(int i)
        {
