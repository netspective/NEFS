...
public final class PersonStudyRelationshipTable
{
    ...
    public PersonStudyRelationshipTable(Table table)
    {
    ...
    public final PersonStudyRelationshipTable.Record createChildLinkedByParentId(PersonTable.Record parentRecord)
    {
        return new PersonStudyRelationshipTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final PersonStudyRelationshipTable.Record createRecord()
    {
        return new PersonStudyRelationshipTable.Record(table.createRow());
    }
    ...
    public final PersonStudyRelationshipTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
     ...
     *  PersonStudy_Relationship.parent_id; Referenced Columns: Person.person_id
     */
    public final PersonStudyRelationshipTable.Records getParentRecordsByParentId(PersonTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final PersonStudyRelationshipTable.Record getRecord(Row row)
    {
        return new PersonStudyRelationshipTable.Record(row);
    }
    
    public final PersonStudyRelationshipTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.Long systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new PersonStudyRelationshipTable.Record(row) : null;
        return result;
    }
    
    public final PersonStudyRelationshipTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.PersonStudyRelationship getValues()
        {
            return getValues(new auto.dal.db.vo.impl.PersonStudyRelationshipVO());
        }
        
        public final auto.dal.db.vo.PersonStudyRelationship getValues(auto.dal.db.vo.PersonStudyRelationship valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.PersonStudyRelationship valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final PersonStudyRelationshipTable.Record get(int i)
        {
