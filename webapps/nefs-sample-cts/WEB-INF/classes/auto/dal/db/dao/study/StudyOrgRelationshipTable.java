...
public final class StudyOrgRelationshipTable
{
    ...
    public StudyOrgRelationshipTable(Table table)
    {
    ...
    public final StudyOrgRelationshipTable.Record createChildLinkedByParentId(StudyTable.Record parentRecord)
    {
        return new StudyOrgRelationshipTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final StudyOrgRelationshipTable.Record createRecord()
    {
        return new StudyOrgRelationshipTable.Record(table.createRow());
    }
    ...
    public final StudyOrgRelationshipTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
     ...
     *  StudyOrg_Relationship.parent_id; Referenced Columns: Study.study_id
     */
    public final StudyOrgRelationshipTable.Records getParentRecordsByParentId(StudyTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final StudyOrgRelationshipTable.Record getRecord(Row row)
    {
        return new StudyOrgRelationshipTable.Record(row);
    }
    
    public final StudyOrgRelationshipTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.Long systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new StudyOrgRelationshipTable.Record(row) : null;
        return result;
    }
    
    public final StudyOrgRelationshipTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.StudyOrgRelationship getValues()
        {
            return getValues(new auto.dal.db.vo.impl.StudyOrgRelationshipVO());
        }
        
        public final auto.dal.db.vo.StudyOrgRelationship getValues(auto.dal.db.vo.StudyOrgRelationship valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.StudyOrgRelationship valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final StudyOrgRelationshipTable.Record get(int i)
        {
