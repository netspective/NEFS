...
public final class PerLanguageIdSetTable
{
    ...
    public PerLanguageIdSetTable(Table table)
    {
    ...
    public final PerLanguageIdSetTable.Record createChildLinkedByParentId(PersonTable.Record parentRecord)
    {
        return new PerLanguageIdSetTable.Record(table.createRow(parentIdForeignKey, parentRecord.getRow()));
    }
    
    public final PerLanguageIdSetTable.Record createRecord()
    {
        return new PerLanguageIdSetTable.Record(table.createRow());
    }
    ...
    public final PerLanguageIdSetTable.Records getAccessorRecords(ConnectionContext cc, QueryDefnSelect accessor, Object[] bindValues)
    ...
    /**
     * Parent reference: ParentForeignKey Sources: Per_language_id_Set.parent_id;
     *  Referenced Columns: Person.person_id
     */
    public final PerLanguageIdSetTable.Records getParentRecordsByParentId(PersonTable.Record parentRecord, ConnectionContext cc)
    throws NamingException, SQLException
    {
    ...
    public final PerLanguageIdSetTable.Record getRecord(Row row)
    {
        return new PerLanguageIdSetTable.Record(row);
    }
    
    public final PerLanguageIdSetTable.Record getRecordByPrimaryKey(ConnectionContext cc, java.lang.Long systemId)
    throws NamingException, SQLException
    {
        Row row = table.getRowByPrimaryKeys(cc, new Object[] { systemId }, null);
        Record result = row != null ? new PerLanguageIdSetTable.Record(row) : null;
        return result;
    }
    
    public final PerLanguageIdSetTable.Record getRecordByPrimaryKey(ConnectionContext cc, PrimaryKeyColumnValues pkValues)
    throws NamingException, SQLException
    {
    ...
    public final class Record
    {
        ...
        public final auto.dal.db.vo.PerLanguageIdSet getValues()
        {
            return getValues(new auto.dal.db.vo.impl.PerLanguageIdSetVO());
        }
        
        public final auto.dal.db.vo.PerLanguageIdSet getValues(auto.dal.db.vo.PerLanguageIdSet valueObject)
        {
        ...
        public final void setValues(auto.dal.db.vo.PerLanguageIdSet valueObject)
        {
    ...
    public final class Records
    {
        ...
        public final PerLanguageIdSetTable.Record get(int i)
        {
