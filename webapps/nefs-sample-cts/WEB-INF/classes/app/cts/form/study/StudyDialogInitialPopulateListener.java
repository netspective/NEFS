...
/**
 * $Id: StudyDialogInitialPopulateListener.java,v 1.1 2003-10-10 17:50:18 aye.thu Exp $
 */
...
import com.netspective.sparx.form.DialogPopulateException;
...
public class StudyDialogInitialPopulateListener implements DialogInitialPopulateListener
{
    ...
    public void populateInitialDialogValues(DialogContext dc, int formatType) throws DialogPopulateException
    {
        if (dc.editingData() || dc.deletingData())
        {
            String idParam = dc.getHttpRequest().getParameter("study_id");
            if (idParam == null || idParam.length() == 0)
                throw new DialogPopulateException("Study ID was not found in the request object.");
            ...
            catch (NamingException e)
            {
                ...
                throw new DialogPopulateException(e);
            }
