...
/**
 * $Id: AbstractPerspectiveDialog.java,v 1.1 2003-09-23 04:23:49 aye.thu Exp $
 */
...
public abstract class AbstractPerspectiveDialog extends Dialog
{
    ...
    public void execute(Writer writer, DialogContext dc) throws IOException, DialogExecuteException
    {
        ...
        {
            handlePostExecuteException(writer, dc, "Error occurred during execution.", e);
        }
        finally
        {
            try
