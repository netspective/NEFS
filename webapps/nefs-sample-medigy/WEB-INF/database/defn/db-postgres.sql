...
CREATE SEQUENCE PERREL_SYSTEM_ID_SEQ increment 1 start 1;
...
CREATE SEQUENCE PEOREL_SYSTEM_ID_SEQ increment 1 start 1;
...
CREATE SEQUENCE ORGAPTYSPRBL_IDST_SYSTEM_ID_SEQ increment 1 start 1;
...
CREATE SEQUENCE ORGREL_SYSTEM_ID_SEQ increment 1 start 1;
...
(
    ...
    activity_stamp TIMESTAMP NOT NULL, /* type.DateTimeColumn */
...
(
    session_id VARCHAR(36), /* type.GuidTextColumn */
    view_init TIMESTAMP NOT NULL, /* type.DateTimeColumn */
    view_latest TIMESTAMP NOT NULL, /* type.DateTimeColumn */
