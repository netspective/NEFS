...
(
    ...
    system_id VARCHAR(36) PRIMARY KEY, /* type.GuidColumn */
    person_id VARCHAR(36), /* type.GuidTextColumn */
    ethnicity_id NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
...
(
    ...
    login_status NUMBER(8) NOT NULL, /* type.RecordStatusIdColumn */
...
(
    ...
    duration NUMBER(8) NOT NULL, /* type.IntegerColumn */
...
CREATE SEQUENCE ORGAPTYSPRBL_IDST_SYSTEM_ID_SEQ increment by 1 start with 1 nomaxvalue nocache nocycle;
...
(
    ...
    org_id VARCHAR(36) NOT NULL, /* type.GuidTextColumn */
    active NUMBER(1) NOT NULL, /* type.BooleanColumn */
    caption VARCHAR(128) NOT NULL, /* type.TextColumn */
    start_time DATE NOT NULL, /* type.TimeColumn */
    end_time DATE NOT NULL, /* type.TimeColumn */
    available NUMBER(1) NOT NULL, /* type.BooleanColumn */
...
(
    ...
    start_stamp TIMESTAMP NOT NULL, /* type.DateTimeColumn */
...
(
    ...
    system_id VARCHAR(36) PRIMARY KEY, /* type.GuidColumn */
    org_id VARCHAR(36), /* type.GuidTextColumn */
    item_id NUMBER(8) NOT NULL, /* type.IntegerColumn */
    caption VARCHAR(96) NOT NULL, /* type.TextColumn */
    abbrev VARCHAR(32), /* type.TextColumn */
...
(
    ...
    spec_type_id NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
    spec_subtype VARCHAR(128), /* type.TextColumn */
    source_id VARCHAR(255), /* type.TextColumn */
    source_type_id NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
...
(
    ...
    rec_state_id NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
...
(
    ...
    assn_status_id NUMBER(8), /* type.RecordStatusIdColumn */
    assn_type_id NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
...
(
    ...
    rec_stat_id NUMBER(8) NOT NULL, /* type.RecordStatusIdColumn */
    event_id VARCHAR(36) PRIMARY KEY, /* type.GuidColumn */
    event_type_id NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
...
(
    ...
    first_access TIMESTAMP NOT NULL, /* type.DateTimeColumn */
    last_access TIMESTAMP NOT NULL, /* type.DateTimeColumn */
...
(
    ...
    activity_type NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
    activity_stamp TIMESTAMP DEFAULT sysdate NOT NULL, /* type.DateTimeColumn */
    action_type NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
...
(
    session_id VARCHAR(36), /* type.GuidTextColumn */
    view_init TIMESTAMP DEFAULT sysdate NOT NULL, /* type.DateTimeColumn */
    view_latest TIMESTAMP DEFAULT sysdate NOT NULL, /* type.DateTimeColumn */
