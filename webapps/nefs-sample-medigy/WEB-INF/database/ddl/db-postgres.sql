...
CREATE TABLE Action
(
    cr_stamp TIMESTAMP NOT NULL, /* type.DateTimeColumn */
...
(
    ...
    deductible NUMERIC(12,2), /* type.CurrencyColumn */
    deductible_met NUMERIC(12,2), /* type.CurrencyColumn */
    ovcopay NUMERIC(12,2), /* type.CurrencyColumn */
    labcopay NUMERIC(12,2), /* type.CurrencyColumn */
    xraycopay NUMERIC(12,2), /* type.CurrencyColumn */
...
(
    ...
    content_large BYTEA, /* type.DataBlockColumn */
...
(
    ...
    upd_stamp TIMESTAMP NOT NULL, /* type.DateTimeColumn */
...
(
    ...
    cost NUMERIC(12,2), /* type.CurrencyColumn */
...
(
    ...
    ind_deduct_amt NUMERIC(12,2), /* type.CurrencyColumn */
    fam_deduct_amt NUMERIC(12,2), /* type.CurrencyColumn */
    percent_pmt FLOAT, /* type.FloatColumn */
    threshold_amt NUMERIC(12,2), /* type.CurrencyColumn */
    copay_amt NUMERIC(12,2), /* type.CurrencyColumn */
...
CREATE SEQUENCE PERETHST_SYSTEM_ID_SEQ increment 1 start 1;
...
CREATE SEQUENCE PERLANGST_SYSTEM_ID_SEQ increment 1 start 1;
...
CREATE SEQUENCE APTYSPRBL_IDST_SYSTEM_ID_SEQ increment 1 start 1;
...
(
    ...
    activity_stamp TIMESTAMP, /* type.DateTimeColumn */
...
(
    session_id VARCHAR(36), /* type.GuidTextColumn */
    view_init TIMESTAMP, /* type.DateTimeColumn */
    view_latest TIMESTAMP, /* type.DateTimeColumn */
