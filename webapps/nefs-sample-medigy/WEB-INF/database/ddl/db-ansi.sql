...
(
    ...
    content_large No definition found in column 'type.DataBlockColumn [20] content_large' for policy 'ansi' or ANSI. Available: [postgres, oracle, mssql, hsqldb], /* type.DataBlockColumn */
...
(
    ...
    content_uri VARCHAR(512), /* type.TextColumn */
    content_small VARCHAR(4000), /* type.TextColumn */
    content_large No definition found in column 'type.DataBlockColumn [24] content_large' for policy 'ansi' or ANSI. Available: [postgres, oracle, mssql, hsqldb], /* type.DataBlockColumn */
