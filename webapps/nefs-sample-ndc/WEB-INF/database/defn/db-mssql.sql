...
(
    ...
    CONSTRAINT FK_LST_FIRM_SEQ_NO FOREIGN KEY (firm_seq_no) REFERENCES firms (firm_seq_no)
);
CREATE  INDEX lst_tradename on listings (tradename);
CREATE  INDEX PK_listings on listings (listing_seq_no);

CREATE TABLE drugclas
(
    ...
    CONSTRAINT FK_DGC_LISTING_SEQ_NO FOREIGN KEY (listing_seq_no) REFERENCES listings (listing_seq_no)
);
...
(
    ...
    CONSTRAINT FK_FRM_LISTING_SEQ_NO FOREIGN KEY (listing_seq_no) REFERENCES listings (listing_seq_no)
);
...
(
    ...
    CONSTRAINT FK_PKG_LISTING_SEQ_NO FOREIGN KEY (listing_seq_no) REFERENCES listings (listing_seq_no)
);
...
(
    ...
    CONSTRAINT FK_RTS_LISTING_SEQ_NO FOREIGN KEY (listing_seq_no) REFERENCES listings (listing_seq_no)
);
