...
(
    account_id INTEGER IDENTITY PRIMARY KEY, /* type.AutoIncColumn */
    ...
    CONSTRAINT FK_ACCOUNTS_LOGIN_ID FOREIGN KEY (login_id) REFERENCES Login (login_id)

    /* DELAYED: CONSTRAINT FK_ACCOUNTS_FAVCATEGORY FOREIGN KEY (favcategory) REFERENCES Favorite_Type (id) (Favorite_Type table not created yet) */
    /* DELAYED: CONSTRAINT FK_ACCOUNTS_LANGPREF FOREIGN KEY (langpref) REFERENCES Language (id) (Language table not created yet) */
);
...
(
    ...
    list_price MONEY NOT NULL, /* type.CurrencyColumn */
    unit_cost MONEY, /* type.CurrencyColumn */
    ...
    CONSTRAINT FK_ITEMS_PRODUCT_ID FOREIGN KEY (product_id) REFERENCES Product (product_id)

    /* DELAYED: CONSTRAINT FK_ITEMS_SUPPLIER_ID FOREIGN KEY (supplier_id) REFERENCES Supplier (supplier_id) (Supplier table not created yet) */
);
...
(
    supplier_id INTEGER IDENTITY PRIMARY KEY, /* type.AutoIncColumn */
...
CREATE TABLE Orders
(
    orders_id INTEGER IDENTITY PRIMARY KEY, /* type.AutoIncColumn */
    account_id INTEGER, /* type.LongIntegerColumn */
    order_date DATETIME NOT NULL, /* type.DateColumn */
    ...
    CONSTRAINT FK_ORDS_ACCOUNT_ID FOREIGN KEY (account_id) REFERENCES Account (account_id)
);
...
(
    orderstatus_id INTEGER IDENTITY PRIMARY KEY, /* type.AutoIncColumn */
    orders_id INTEGER, /* type.LongIntegerColumn */
    itemnum INTEGER NOT NULL, /* type.IntegerColumn */
    ts DATETIME NOT NULL, /* type.DateColumn */
    status VARCHAR(20) NOT NULL, /* type.TextColumn */

    CONSTRAINT FK_ORDERSTAT_ORDERS_ID FOREIGN KEY (orders_id) REFERENCES Orders (orders_id)
);
...
(
    lineitem_id INTEGER IDENTITY PRIMARY KEY, /* type.AutoIncColumn */
    orders_id INTEGER, /* type.LongIntegerColumn */
    itemnum INTEGER, /* type.IntegerColumn */
    item_id VARCHAR(32), /* type.TextColumn */
    quantity INTEGER NOT NULL, /* type.IntegerColumn */
    unit_price MONEY NOT NULL, /* type.CurrencyColumn */

    CONSTRAINT FK_LINEITEMS_ORDERS_ID FOREIGN KEY (orders_id) REFERENCES Orders (orders_id),
    CONSTRAINT FK_LINEITEMS_ITEM_ID FOREIGN KEY (item_id) REFERENCES Item (item_id)
);
...
ALTER TABLE Account ADD CONSTRAINT FK_ACCOUNTS_FAVCATEGORY FOREIGN KEY (favcategory) REFERENCES Favorite_Type (id);
ALTER TABLE Item ADD CONSTRAINT FK_ITEMS_SUPPLIER_ID FOREIGN KEY (supplier_id) REFERENCES Supplier (supplier_id);
ALTER TABLE Account ADD CONSTRAINT FK_ACCOUNTS_LANGPREF FOREIGN KEY (langpref) REFERENCES Language (id);
