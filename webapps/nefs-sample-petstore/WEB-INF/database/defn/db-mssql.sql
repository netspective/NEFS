...
(
    ...
    listprice MONEY NOT NULL, /* type.CurrencyColumn */
    unitcost MONEY, /* type.CurrencyColumn */
...
(
    ...
    account_id INTEGER, /* type.LongIntegerColumn */
    orderdate DATETIME NOT NULL, /* type.DateColumn */
...
(
    ...
    unitprice MONEY NOT NULL, /* type.CurrencyColumn */
...
ALTER TABLE Profile ADD CONSTRAINT FK_PROFILES_ACCOUNT_ID FOREIGN KEY (account_id) REFERENCES Account (account_id);
ALTER TABLE Profile ADD CONSTRAINT FK_PROFILES_FAVCATEGORY FOREIGN KEY (favcategory) REFERENCES BannerData (bannerdata_id);
ALTER TABLE Profile ADD CONSTRAINT FK_PROFILES_LANGPREF FOREIGN KEY (langpref) REFERENCES Language (id);
