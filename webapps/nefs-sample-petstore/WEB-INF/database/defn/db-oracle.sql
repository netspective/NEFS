...
CREATE SEQUENCE ACCOUNTS_ACCOUNT_ID_SEQ increment by 1 start with 1 nomaxvalue nocache nocycle;
CREATE TABLE Account
(
    account_id NUMBER(16) PRIMARY KEY, /* type.AutoIncColumn */
    ...
    langpref NUMBER(8) NOT NULL, /* type.EnumerationIdRefColumn */
    favcategory NUMBER(8), /* type.EnumerationIdRefColumn */
...
(
    ...
    list_price NUMBER(12,2) NOT NULL, /* type.CurrencyColumn */
    unit_cost NUMBER(12,2), /* type.CurrencyColumn */
    supplier_id NUMBER(16), /* type.LongIntegerColumn */
...
CREATE SEQUENCE SUPPLS_SUPPLIER_ID_SEQ increment by 1 start with 1 nomaxvalue nocache nocycle;
CREATE TABLE Supplier
(
    supplier_id NUMBER(16) PRIMARY KEY, /* type.AutoIncColumn */
...
CREATE SEQUENCE ORDS_ORDERS_ID_SEQ increment by 1 start with 1 nomaxvalue nocache nocycle;
CREATE TABLE Orders
(
    orders_id NUMBER(16) PRIMARY KEY, /* type.AutoIncColumn */
    account_id NUMBER(16), /* type.LongIntegerColumn */
...
CREATE SEQUENCE ORDERSTAT_ORDERSTATUS_ID_SEQ increment by 1 start with 1 nomaxvalue nocache nocycle;
CREATE TABLE OrderStatus
(
    orderstatus_id NUMBER(16) PRIMARY KEY, /* type.AutoIncColumn */
    orders_id NUMBER(16), /* type.LongIntegerColumn */
    itemnum NUMBER(8) NOT NULL, /* type.IntegerColumn */
...
CREATE SEQUENCE LINEITEMS_LINEITEM_ID_SEQ increment by 1 start with 1 nomaxvalue nocache nocycle;
CREATE TABLE LineItem
(
    lineitem_id NUMBER(16) PRIMARY KEY, /* type.AutoIncColumn */
    orders_id NUMBER(16), /* type.LongIntegerColumn */
    itemnum NUMBER(8), /* type.IntegerColumn */
    item_id VARCHAR(32), /* type.TextColumn */
    quantity NUMBER(8) NOT NULL, /* type.IntegerColumn */
    unit_price NUMBER(12,2) NOT NULL, /* type.CurrencyColumn */
