...
/**
 * $Id: AppNavigationSkin.java,v 1.1 2004-02-23 14:22:28 robert.yuhasz Exp $
 */
...
public class AppNavigationSkin extends AbstractThemeSkin implements NavigationSkin
{
    ...
    public void renderPageHeader(Writer writer, NavigationContext nc) throws IOException
    {
      ...
      /*  writer.write("<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>\n");
        ...
        writer.write("<TABLE cellSpacing=0 width='100%' background='"+ nc.getRootUrl() +"/resources/images/bkg-topbar.gif' border=0>");
        writer.write("<TBODY>");
        writer.write("<TR>");
        writer.write("<TD><A href='home'><IMG src='"+ nc.getRootUrl() +"/resources/images/logo-topbar.gif' border=0></A></TD>");
        writer.write("<TD align=left>");
        writer.write("<FORM action=search>");
        writer.write("<FONT color='cyan' size=-1>What are you looking for?</FONT> <BR><INPUT size=14 name=search_text>");
        writer.write("<INPUT type=image src='"+ nc.getRootUrl() +"/resources/images/search.gif' border=0 name=search>");
        writer.write("</FORM></TD>");
        writer.write("<TD align=right><A href='cart?item_id=none&action=update'>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart.gif' border=0 name=img_cart></A>");

        boolean signedin = false;
        if(nc.getHttpRequest().getSession().getAttribute("signedin")!=null)
          if(nc.getHttpRequest().getSession().getAttribute("signedin").toString().equals("yes"))
               signedin=true;
        if(!signedin) {
           writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/separator.gif' border=0>");
           writer.write("<A href='signin'>");
           writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/sign-in.gif' border=0 name=img_signin></A>");
        }
        else {
            writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/separator.gif' border=0>");
            writer.write("<A href='signout'>");
            writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/sign-out.gif' border=0 name=img_signout></A>");
            writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/separator.gif' border=0>");
            writer.write("<A href='editaccount'>");
            writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/my_account.gif' border=0  name=img_myaccount></A>");
        }
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/separator.gif' border=0> <A href='help'>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/help.gif' border=0 name=img_help></A>");
        writer.write("</TD></TR></TBODY></TABLE>");
        writer.write("<TABLE height=20 cellSpacing=0 width='100%'");
        writer.write("background='"+ nc.getRootUrl() +"/resources/images/cart/white.htm' border=0>");
        writer.write("<TBODY>");
        writer.write("<TR>");
        writer.write("<TD align=middle><A href='category?category_id=FISH'>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/fish.gif' border=0 name=img_fish></A>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/separator.gif' border=0>");
        writer.write("<A href='category?category_id=DOGS'>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/dogs.gif' border=0 name=img_dogs></A>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/separator.gif' border=0>");
        writer.write("<A href='category?category_id=REPTILES'>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/reptiles.gif' border=0 name=img_reptiles></A>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/separator.gif' border=0>");
        writer.write("<A href='category?category_id=CATS'>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/cats.gif' border=0 name=img_cats></A>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/separator.gif' border=0>");
        writer.write("<A href='category?category_id=BIRDS'>");
        writer.write("<IMG src='"+ nc.getRootUrl() +"/resources/images/cart/birds.gif' border=0 name=img_birds></A>");
        writer.write("</TD></TR></TBODY></TABLE>");

        writer.write("<!-- BEGIN CONTENT TABLE -->\n");
        writer.write("<table width='100%' border='0' cellpadding='0' cellspacing='0' height=90%>\n");
        writer.write("  <tr valign='top'>\n");
        //writer.write("    <td width='5%' background='"+ nc.getRootUrl() +"/resources/collage.gif'>&nbsp;</td>\n");
        //writer.write("    <td width='2%' bgcolor='#FFFFFF'>\n");
