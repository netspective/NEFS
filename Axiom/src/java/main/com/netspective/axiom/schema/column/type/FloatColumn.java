...
{
    public class FloatColumnValue extends BasicColumnValue
    {
        ...
        {
            setValue(new Float(rs.getFloat(colIndex)));
        }
    }

    public FloatColumn(Table table)
    {
        super(table);
