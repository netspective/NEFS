...
/**
 * $Id: IntegerColumn.java,v 1.2 2003-06-13 03:45:30 roque.hernandez Exp $
 */
...
public class IntegerColumn extends BasicColumn
{
    public class IntegerColumnValue extends BasicColumnValue
    {
    ...
    public IntegerColumn(Table table)
    {
        super(table);
