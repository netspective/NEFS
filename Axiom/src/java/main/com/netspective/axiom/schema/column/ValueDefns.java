...
/**
 * $Id: ValueDefns.java,v 1.1 2003-03-13 18:25:41 shahid.shah Exp $
 */
...
public class ValueDefns
{
    ...
    public ValueDefns(Column column)
    {
        this.column = column;
        defaultSqlExprValues = new DbmsSqlTexts(column, VARNAME_COLUMN);
    }

    public void merge(ValueDefns sqlDataDefns)
    {
