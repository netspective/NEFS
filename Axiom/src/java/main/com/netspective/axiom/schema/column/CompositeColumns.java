...
/**
 * $Id: CompositeColumns.java,v 1.1 2003-03-13 18:25:41 shahid.shah Exp $
 */
...
public class CompositeColumns
{
    ...
    public CompositeColumns(Column parent)
    {
        this.parent = parent;
    }
    ...
    {
        return parent.getTable().createColumn();
    }
    ...
    {
        return parent.getTable().createColumn(cls);
    }

    public void addColumn(Column column)
    {
        parent.getTable().addColumn(column);
    }
}
