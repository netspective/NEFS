...
public class LongIntegerColumn extends BasicColumn
{
    public class LongIntegerColumnValue extends BasicColumnValue
    {
        ...
        {
            setValue(new Long(rs.getLong(colIndex)));
        }
    }

    public LongIntegerColumn(Table table)
    {
        super(table);
    ...
    {
        return new LongIntegerColumnValue();
    }
}
