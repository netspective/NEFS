...
public class SchemaDiagramTableNameNodeGenerator extends SchemaDiagramTableStructureNodeGenerator
{
    public SchemaDiagramTableNameNodeGenerator(String name)
    {
        super(name);
