...
public class AutoIncColumn extends LongIntegerColumn implements GeneratedValueColumn
{
    public AutoIncColumn(Table table)
    {
        super(table);
    ...
    {
        return cc.getDatabasePolicy().handleAutoIncPreDmlInsertExecute(cc, this);
    }
    ...
    {
        return cc.getDatabasePolicy().handleAutoIncPostDmlInsertExecute(cc, this, valueFromPreDmlExecute);
    }
}
