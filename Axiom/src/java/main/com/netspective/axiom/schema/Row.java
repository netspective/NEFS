...
/**
 * $Id: Row.java,v 1.1 2003-03-13 18:25:40 shahid.shah Exp $
 */
...
public interface Row extends DatabasePolicy.RowInsertListener, DatabasePolicy.RowUpdateListener, DatabasePolicy.RowDeleteListener
{
    /**
    ...
    /**
     * Returns the values in the row that belong to the primary keys
     */
