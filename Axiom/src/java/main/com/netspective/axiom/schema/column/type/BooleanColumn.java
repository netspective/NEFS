...
/**
 * $Id: BooleanColumn.java,v 1.1 2003-03-13 18:25:41 shahid.shah Exp $
 */
...
{
    public class BooleanColumnValue extends BasicColumnValue
    {
    ...
    public BooleanColumn(Table table)
    {
        super(table);
