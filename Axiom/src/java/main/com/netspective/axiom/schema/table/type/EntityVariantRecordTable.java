...
public class EntityVariantRecordTable extends BasicTable
{
    private Column entityIdColumn;
    private EntityVariantRecordTypeIdRefColumn typeIdColumn;
    private Column valueColumn;
    private String entityIdColName;
    private String typeIdColName;
    private String valueColName;

    public EntityVariantRecordTable(Column parentColumn)
    {
        super(parentColumn);
    }

    public EntityVariantRecordTable(Schema schema)
    {
        super(schema);
    }
    ...
    {
        return new EntityVariantRecordTableRow(this);
    }

    public Rows createRows()
    {
        return new EntityVariantRecordTableRows(this);
    }
    ...
    public void finishConstruction()
    {
        ...
        this.entityIdColumn = columns.getByName(entityIdColName);
        this.typeIdColumn = (EntityVariantRecordTypeIdRefColumn) columns.getByName(typeIdColName);
        this.valueColumn = columns.getByName(valueColName);
    }
    ...
    public EntityVariantRecordTypeIdRefColumn getTypeIdColumn()
    {
        return typeIdColumn;
    }
