...
/**
 * $Id: GuidColumn.java,v 1.1 2003-03-13 18:25:41 shahid.shah Exp $
 */
...
public class GuidColumn extends GuidTextColumn implements GeneratedValueColumn
{
    public GuidColumn(Table table)
    {
        super(table);
    ...
    {
        return cc.getDatabasePolicy().handleGUIDPreDmlInsertExecute(cc, this);
    }
    ...
    {
        return cc.getDatabasePolicy().handleGUIDPostDmlInsertExecute(cc, this, valueFromPreDmlExecute);
    }
}
