...
public class BasicDatabasePolicyValueContext extends DefaultValueContext implements DatabasePolicyValueContext
{
    ...
    public BasicDatabasePolicyValueContext(DatabasePolicy databasePolicy)
    {
        this.databasePolicy = databasePolicy;
    }

    public BasicDatabasePolicyValueContext(String dbmsIdentifier)
    {
        this.databasePolicy = DatabasePolicies.getInstance().getDatabasePolicy(dbmsIdentifier);
    }
