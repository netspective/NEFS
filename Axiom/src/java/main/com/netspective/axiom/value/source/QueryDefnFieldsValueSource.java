...
/**
 * $Id: QueryDefnFieldsValueSource.java,v 1.1 2003-05-30 23:06:54 shahid.shah Exp $
 */
...
public class QueryDefnFieldsValueSource extends QueryDefnItemValueSource
{
    ...
    public QueryDefnFieldsValueSource()
    {
    }

    public QueryDefnFieldsValueSource(QueryDefinition queryDefn)
    {
        super(queryDefn);
    }
    ...
    public PresentationValue getPresentationValue(ValueContext vc)
    {
        ...
        QueryDefinition qd = getQueryDefn(dcvc);
