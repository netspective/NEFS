...
/**
 * $Id: QueryDefnJoins.java,v 1.1 2003-03-13 18:25:43 shahid.shah Exp $
 */
...
public class QueryDefnJoins
{
    ...
    private Map joinsByName = new HashMap();
    private List autoIncludeJoins = new ArrayList();
    private boolean autoIncCached;

    public QueryDefnJoins()
    {
    }
    ...
    public void add(QueryDefnJoin join)
    {
        ...
        autoIncCached = false; // make sure that our auto includes list gets regenerated
    }

    public QueryDefnJoin get(int i)
    {
        return (QueryDefnJoin) joins.get(i);
    }

    public QueryDefnJoin get(String name)
    {
        return (QueryDefnJoin) joinsByName.get(name);
    }
