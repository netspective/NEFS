...
/**
 * $Id: EndsWithComparisonIgnoreCase.java,v 1.1 2004-03-19 03:12:20 shahid.shah Exp $
 */
...
public class EndsWithComparisonIgnoreCase extends BinaryOpComparison
{
    public EndsWithComparisonIgnoreCase()
    {
        super("ends-with-ignore-case", "ends with (ignore case)", "string");
    }
    ...
    {
        statement.addParam(new ConcatenateValueSource("%", cond.getValue(), null));
        String retString = "";
