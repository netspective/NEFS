...
/**
 * $Id: QueryDefnSqlWhereExpression.java,v 1.1 2003-03-13 18:25:44 shahid.shah Exp $
 */
...
public class QueryDefnSqlWhereExpression
{
    ...
    private int connector = QueryDefnCondition.CONNECT_AND;

    public QueryDefnSqlWhereExpression(QueryDefinition owner)
    {
        this.owner = owner;
    }
    ...
    public String getWhereCondExpr(QueryDefnSelectStmtGenerator stmt, ValueContext vc)
    {
        return value != null ? value.getTextValue(vc) : null;
    }
