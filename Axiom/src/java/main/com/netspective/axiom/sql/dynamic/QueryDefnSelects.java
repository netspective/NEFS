...
/**
 * $Id: QueryDefnSelects.java,v 1.1 2003-03-13 18:25:44 shahid.shah Exp $
 */
...
public class QueryDefnSelects
{
    ...
    private Map selectsByName = new HashMap();
    ...
    public void add(QueryDefnSelect select)
    {
        selects.add(select);
    ...
    public QueryDefnSelect get(String name)
    {
