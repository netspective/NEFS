...
public class QueryDefnSqlWhereExpressions
{
    private List list = new ArrayList();

    public QueryDefnSqlWhereExpressions()
    {
    }
    ...
    public void add(QueryDefnSqlWhereExpression expr)
    {
        list.add(expr);
    }

    public QueryDefnSqlWhereExpression get(int i)
    {
