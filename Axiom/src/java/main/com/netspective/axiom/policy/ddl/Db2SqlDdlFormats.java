...
public class Db2SqlDdlFormats extends AnsiSqlDdlFormats
{
    public static final XmlDataModelSchema.Options XML_DATA_MODEL_SCHEMA_OPTIONS = new XmlDataModelSchema.Options().setIgnorePcData(true);

    public Db2SqlDdlFormats()
    {
        super();
        setCreateSequenceStatementFormat("CREATE SEQUENCE ${column.sequenceName} AS INT START WITH 1 INCREMENT BY 1 MINVALUE 1 NO MAXVALUE NO CYCLE NO CACHE ORDER");
