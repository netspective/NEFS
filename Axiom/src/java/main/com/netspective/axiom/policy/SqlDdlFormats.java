...
/**
 * $Id: SqlDdlFormats.java,v 1.6 2004-08-12 16:28:50 shahid.shah Exp $
 */
...
{
    /**
     * Obtain the template that should be executed and contents inserted before any other DDL content is
     * generated by the DdlGenerator.
     */
    public TemplateProcessor getPreDdlContentTemplate();

    /**
     * Obtain the template that should be executed and contents inserted after the create objects but before any
     * static data (enumerations, etc) is generated by the DdlGenerator.
     */
    public TemplateProcessor getPreStaticDataContentTemplate();

    /**
     * Obtain the template that should be executed and contents after all other DDL content is
     * generated by the DdlGenerator.
     */
