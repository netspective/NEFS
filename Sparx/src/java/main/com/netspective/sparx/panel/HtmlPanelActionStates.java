...
/**
 * $Id: HtmlPanelActionStates.java,v 1.1 2004-03-02 07:40:53 aye.thu Exp $
 */
...
public class HtmlPanelActionStates
{
    private HtmlPanelValueContext panelContext;
    private Map statesByQualifiedName = new HashMap();

    public HtmlPanelActionStates(HtmlPanelValueContext panelContext)
    {
        this.panelContext = panelContext;
    }

    public void addState(HtmlPanelAction.State state)
    {
        statesByQualifiedName.put(state.getPanelAction().getCaption().getTextValue(panelContext), state);
    }
