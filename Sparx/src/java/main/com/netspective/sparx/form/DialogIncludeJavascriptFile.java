...
public class DialogIncludeJavascriptFile
{
    ...
    static
    {
        XML_DATA_MODEL_SCHEMA_OPTIONS.addRequiredAttributes(new String[]{"href"});
    }

    private ValueSource href;

    public DialogIncludeJavascriptFile()
    {
    }

    public ValueSource getHref()
    {
        return href;
    }
