...
{
    public static final DialogExecuteHandlerTemplateConsumer INSTANCE = new DialogExecuteHandlerTemplateConsumer();

    public DialogExecuteHandlerTemplateConsumer()
    {
    ...
    {
        return DialogExecuteHandler.class.getName();
    }
}
