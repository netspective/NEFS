...
/**
 * $Id: DialogExecuteHandlers.java,v 1.1 2003-08-06 01:05:37 shahid.shah Exp $
 */
...
public class DialogExecuteHandlers
{
    private List handlers = new ArrayList();

    public DialogExecuteHandlers()
    {
    }
    ...
    public DialogExecuteHandler get(int index)
    {
        return (DialogExecuteHandler) handlers.get(index);
    }
