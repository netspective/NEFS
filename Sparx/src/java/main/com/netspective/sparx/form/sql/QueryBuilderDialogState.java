 ...
 *
 * @author Aye Thu
 * @version $Id: QueryBuilderDialogState.java,v 1.1 2004-02-24 21:28:03 aye.thu Exp $
 */
public class QueryBuilderDialogState extends DialogState
{
    public QueryBuilderDialogState()
    {
        super();
    }

    /**
     * Initializes the query builder dialog's state object
     *
     * @param vc    current servlet value context
     */
