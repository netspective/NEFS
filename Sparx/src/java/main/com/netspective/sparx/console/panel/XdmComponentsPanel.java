...
{
    private static final TabularReport usageReport = new BasicTabularReport();
    private static XdmComponentsPanel instance;
    ...
    static
    {
        ...
        usageReport.getFrame().setHeading(new StaticValueSource("XDM Components Usage"));
    ...
    public static final XdmComponentsPanel getInstance()
    {
        if(instance == null)
            instance = (XdmComponentsPanel) DiscoverSingleton.find(XdmComponentsPanel.class, XdmComponentsPanel.class.getName());
        return instance;
    }
