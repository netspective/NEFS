...
/**
 * $Id: SchemaTableColumnsDalPanel.java,v 1.5 2003-09-15 03:57:45 aye.thu Exp $
 */
...
{
    private static final Log log = LogFactory.getLog(SchemaTableColumnsDalPanel.class);
    ...
    static
    {
        ...
        column = new GeneralColumn();
        column.setHeading(new StaticValueSource("DAL/Value Class"));
        columnsDalReport.addColumn(column);
    }

    public SchemaTableColumnsDalPanel()
    {
