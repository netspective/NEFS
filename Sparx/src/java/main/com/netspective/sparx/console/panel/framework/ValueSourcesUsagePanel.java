...
/**
 * $Id: ValueSourcesUsagePanel.java,v 1.1 2003-05-31 22:26:23 shahid.shah Exp $
 */
...
import com.netspective.sparx.console.panel.framework.ValueSourcesCatalogPanel;
...
public class ValueSourcesUsagePanel extends AbstractHtmlTabularReportPanel
{
    ...
    public ValueSourcesUsagePanel()
    {
        getFrame().setHeading(new StaticValueSource("Value Sources Usage"));
    }
    ...
    public static class UsageReportDataSource extends ValueSourcesCatalogPanel.ValueSourcesDataSource
    {
        ...
        public Object getActiveRowColumnData(int columnIndex, int flags)
        {
            switch(columnIndex)
            {
                ...
                case 1:
                    return reportValueContext.getSkin().constructClassRef(vsClass);

                case 2:
                    if(vsClass.equals(StaticValueSource.class))
                        return new Integer(StaticValueSource.getUsageCount());
                    else
                    {
                        int count = 0;
