...
/**
 * $Id: ResinCompilingClassPathProvider.java,v 1.1 2003-08-09 16:37:04 shahid.shah Exp $
 */
...
public class ResinCompilingClassPathProvider implements ClassPath.ClassPathProvider
{
    private static final Log log = LogFactory.getLog(ResinCompilingClassPathProvider.class);

    private Method getClassPathMethod;
    ...
    {
        return "com.caucho.java.CompilingClassLoader";
    }
}
