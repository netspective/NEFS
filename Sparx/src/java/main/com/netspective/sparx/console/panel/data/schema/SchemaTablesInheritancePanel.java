...
/**
 * $Id: SchemaTablesInheritancePanel.java,v 1.3 2003-09-10 04:02:18 aye.thu Exp $
 */
...
public class SchemaTablesInheritancePanel extends SchemaTablesPanel
{
    ...
    static
    {
        ...
        column.setHeading(new StaticValueSource("Table Type(s) Inherited"));
        descrsReport.addColumn(column);
    }

    public SchemaTablesInheritancePanel()
    {
        getFrame().setHeading(new StaticValueSource("Table Type Inheritance"));
    }
