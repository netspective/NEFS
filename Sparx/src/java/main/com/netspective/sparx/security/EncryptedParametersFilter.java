...
public class EncryptedParametersFilter implements javax.servlet.Filter
{
    private static final Log log = LogFactory.getLog(EncryptedParametersFilter.class);
    private static final String SESSATTRNAME_ENCRYPTION_KEY = "encryption-key";
