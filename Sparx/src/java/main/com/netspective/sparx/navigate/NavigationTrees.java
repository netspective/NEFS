...
/**
 * $Id: NavigationTrees.java,v 1.1 2003-03-23 04:51:52 shahid.shah Exp $
 */
...
public class NavigationTrees
{
    ...
    {
        if(tree.getName() == null || NavigationTree.TREENAME_DEFAULT.equalsIgnoreCase(tree.getName()))
        {
            tree.setName(NavigationTree.TREENAME_DEFAULT);
            defaultTree = tree;
        }
