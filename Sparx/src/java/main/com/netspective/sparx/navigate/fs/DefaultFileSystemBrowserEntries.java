...
public class DefaultFileSystemBrowserEntries implements FileSystemBrowserEntries
{
    private Set folderNames = new HashSet(); // case-sensitive names
    private Set fileNames = new HashSet(); // case-sensitive names
    private Set fileTypes = new HashSet(); // case-insensitive types

    public DefaultFileSystemBrowserEntries()
    {
    }
