...
import com.netspective.sparx.navigate.fts.SearchHitsRenderer.SearchResults;
...
public class FullTextSearchResultsActivity implements Activity
{
    ...
    public FullTextSearchResultsActivity(NavigationContext nc, SearchResults searchResults)
    {
    ...
    {
        final FullTextSearchPage fullTextSearchPage = searchResults.getFullTextSearchPage();
        return fullTextSearchPage.getUrl(navigationContext) + "?" +
               fullTextSearchPage.getRenderer().getExpressionParameterName() + "=" +
               searchResults.getExpression();
    }
