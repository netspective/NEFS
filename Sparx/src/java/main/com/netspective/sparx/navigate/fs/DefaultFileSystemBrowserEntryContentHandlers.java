...
public class DefaultFileSystemBrowserEntryContentHandlers implements FileSystemBrowserEntryContentHandlers
{
    ...
    public FileSystemBrowserEntryContentHandler createHandler()
    {
        return new DefaultFileSystemEntryContentHandler();
    }

    public void addHandler(FileSystemBrowserEntryContentHandler handler)
    {
