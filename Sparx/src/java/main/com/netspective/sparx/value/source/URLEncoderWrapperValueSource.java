...
public class URLEncoderWrapperValueSource extends AbstractValueSource
{
    public static final String[] IDENTIFIERS = new String[]{ "encode" };
    ...
    private ValueSource wrappedValueSource;

    public void initialize(ValueSourceSpecification spec) throws ValueSourceInitializeException
    {
        super.initialize(spec);
        wrappedValueSource = ValueSources.getInstance().getValueSourceOrStatic(spec.getParams());
    }
