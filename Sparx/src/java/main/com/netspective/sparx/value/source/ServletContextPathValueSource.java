...
/**
 * $Id: ServletContextPathValueSource.java,v 1.1 2003-03-23 04:51:53 shahid.shah Exp $
 */
...
public class ServletContextPathValueSource extends AbstractValueSource
{
    ...
    public static final ValueSourceDocumentation DOCUMENTATION = new ValueSourceDocumentation(
            ...
            {
                new ValueSourceDocumentation.Parameter("relative-path", true, null, null, "The relative path of the file.")
            }
    );
