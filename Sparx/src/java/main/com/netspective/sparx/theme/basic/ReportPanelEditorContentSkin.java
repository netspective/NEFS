...
public class ReportPanelEditorContentSkin extends RecordEditorReportSkin
{
    public ReportPanelEditorContentSkin()
    {
        super();
    ...
    public ReportPanelEditorContentSkin(Theme theme, String name, String panelClassNamePrefix, String panelResourcesPrefix, boolean fullWidth)
    {
    ...
    public void produceDataRowDecoratorAppend(Writer writer, HtmlTabularReportValueContext rc, HtmlTabularReportDataSource ds, String[] rowData, boolean isOddRow) throws IOException
    {
        ...
        if(deleteReportActions != null && deleteReportActions.length > 0)
        {
            ...
            String label = "<img src=\"" + theme.getResourceUrl("/images/" + panelResourcesPrefix + "/panel-editor-action-delete.gif") + "\" alt=\"\" border=\"0\">";
