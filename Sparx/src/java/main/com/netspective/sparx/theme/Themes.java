...
/**
 * $Id: Themes.java,v 1.1 2003-03-23 04:51:53 shahid.shah Exp $
 */
...
public class Themes
{
    ...
    public static final String THEMENAME_DEFAULT = "default";
    ...
    public void registerTheme(Theme theme)
    {
        ...
        if(THEMENAME_DEFAULT.equals(theme.getName()))
        {
            defaultTheme = theme;
            if(log.isTraceEnabled())
    ...
    public Theme getDefaultTheme()
    {
        ...
        if(result == null && log.isDebugEnabled())
        {
            log.debug("Unable to find default theme '"+ THEMENAME_DEFAULT +"'. Available: " + themesByName);
            return null;
        }
