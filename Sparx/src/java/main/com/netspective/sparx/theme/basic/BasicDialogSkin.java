 ...
 */
public class BasicDialogSkin extends StandardDialogSkin
{
    private String controlAreaClass;
    private String captionClass;
    private boolean frameVisible;

    public BasicDialogSkin(Theme theme)
    {
        super(theme);
    ...
    {
        String imgPath = getTheme().getResourcesPath().getTextValue(dc) + "/images";
