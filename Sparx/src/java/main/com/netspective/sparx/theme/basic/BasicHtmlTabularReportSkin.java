...
public class BasicHtmlTabularReportSkin extends BasicHtmlPanelSkin implements HtmlTabularReportSkin
{
    ...
    public BasicHtmlTabularReportSkin(Theme theme, String panelStyle, boolean fullWidth)
    {
