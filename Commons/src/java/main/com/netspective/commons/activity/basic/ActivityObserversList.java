...
/**
 * $Id: ActivityObserversList.java,v 1.1 2004-06-23 20:42:51 shahid.shah Exp $
 */

package com.netspective.commons.activity.basic;
...
public class ActivityObserversList implements ActivityObservers
{
    ...
    public ActivityObserver getActivityObserver(int i)
    {
        return (ActivityObserver) observers.get(i);
    }

    public int getActivityObserversCount()
    {
        return observers.size();
    }

    public Iterator getActivityObserversIterator()
    {
