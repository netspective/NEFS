...
/**
 * $Id: MethodJavaDoc.java,v 1.1 2003-08-13 12:18:31 shahid.shah Exp $
 */
...
{
    private static final Log log = LogFactory.getLog(MethodJavaDoc.class);
    private JavaDocs.MethodDocXmlNodeLocator locator;
    private ClassJavaDoc classDoc;

    public MethodJavaDoc(ClassJavaDoc classDoc, String methodName)
    {
        setClassDoc(classDoc);
        setName(methodName);
    }

    public ClassJavaDoc getClassDoc()
    {
        return classDoc;
    }

    protected void setClassDoc(ClassJavaDoc classDoc)
    {
