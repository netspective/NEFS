...
/**
 * $Id: TabularReportBanner.java,v 1.1 2003-03-25 20:59:54 shahid.shah Exp $
 */
...
public class TabularReportBanner
{
    ...
    static public class ItemsStyle extends XdmEnumeratedAttribute
    {
    ...
    static public class Items extends ArrayList
    {
        ...
        private int style = LAYOUTSTYLE_VERTICAL;
        private String separator = ", ";

        public void setStyle(ItemsStyle style)
        {
        ...
        public void produceHtml(Writer writer, TabularReportValueContext rc) throws IOException
        {
            int itemsCount = size();
            ...
            if(style == LAYOUTSTYLE_HORIZONTAL)
            {
                for(int i = 0; i < itemsCount; i++)
                {
                    ...
                    String caption = itemCaption != null ? (itemUrl != null ? ("<a href='" + itemUrl.getValue(rc).getTextValue() + "'>" + itemCaption.getValue(rc).getTextValue() + "</a>") : itemCaption.getValue(rc).getTextValue()) : null;
