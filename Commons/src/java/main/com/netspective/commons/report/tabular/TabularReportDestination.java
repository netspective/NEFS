...
/**
 * $Id: TabularReportDestination.java,v 1.1 2003-03-25 20:59:54 shahid.shah Exp $
 */
...
public class TabularReportDestination
{
    ...
    public TabularReportDestination(int dest, TabularReportValueContext vc, TabularReportSkin skin) throws IOException
    {
        destination = dest;
        initialize(vc, skin);
    }

    public TabularReportDestination(String dest, TabularReportValueContext vc, TabularReportSkin skin) throws IOException
    {
    ...
    public void initialize(TabularReportValueContext vc, TabularReportSkin skin) throws IOException
    {
        Configuration appConfig = vc.getConfigurationsManager().getDefaultConfiguration();
