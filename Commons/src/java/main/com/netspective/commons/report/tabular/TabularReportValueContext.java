...
/**
 * $Id: TabularReportValueContext.java,v 1.4 2003-04-03 12:45:47 shahid.shah Exp $
 */
...
public interface TabularReportValueContext extends ValueContext
{
    ...
    public TabularReportColumnState getState(int col);

    public int getVisibleColsCount();

    public TabularReportColumns getColumns();

    public ColumnDataCalculator getCalc(int col);

    public int getCalcsCount();
