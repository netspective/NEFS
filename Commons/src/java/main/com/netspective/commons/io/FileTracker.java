...
public class FileTracker implements InputSourceTracker
{
    private File file;
    private long lastModified;
    private FileTracker owner;
    private FileTracker parent;
    ...
    public void setOwner(FileTracker owner)
    {
        this.owner = owner;
    }

    public void setParent(FileTracker parent)
    {
        this.parent = parent;
    ...
    public boolean sourceChanged()
    {
        ...
        if(preProcessors != null)
        {
            ...
            {
                if(((FileTracker) preProcessors.get(i)).sourceChanged())
                    return true;
            }
        }
        ...
        if(includes != null)
        {
            ...
            {
                if(((FileTracker) includes.get(i)).sourceChanged())
                    return true;
            }
        }
