...
/**
 * $Id: ValueSourceOrJavaExpressionText.java,v 1.1 2003-03-13 18:33:11 shahid.shah Exp $
 */
...
public class ValueSourceOrJavaExpressionText extends JavaExpressionText
{
    public ValueSourceOrJavaExpressionText()
    {
    }

    public ValueSourceOrJavaExpressionText(String staticExpr)
    {
        super(staticExpr);
    }

    public ValueSourceOrJavaExpressionText(String staticExpr, Map vars)
    {
        super(staticExpr, vars);
    }

    public ValueSourceOrJavaExpressionText(Map vars)
    {
        super(vars);
    }
