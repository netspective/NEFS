...
/**
 * $Id: AbstractValueSource.java,v 1.6 2003-07-09 16:51:07 shahid.shah Exp $
 */
...
abstract public class AbstractValueSource implements ValueSource
{
    ...
    /**
     * The original tokens used to initialize this value source.
     */
    protected ValueSourceSpecification spec;

    public AbstractValueSource()
    {
    ...
    {
        Value value = getValue(vc);
        return value != null ? value.getTextValueOrBlank() : null;
    }
    ...
    {
        return spec != null ? spec.getSpecificationText() : (this.getClass().getName() + " (no spec)");
    }
}