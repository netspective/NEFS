...
public class CreditCardValueValidationRule extends BasicValidationRule
{
    ...
    public CreditCardValueValidationRule(ValueSource caption)
    {
        super(caption);
    }

    public String getInvalidCardNumMessage()
    {
        return invalidCardNumMessage;
    }

    public void setInvalidCardNumMessage(String invalidCardNumMessage)
    {
        this.invalidCardNumMessage = invalidCardNumMessage;
    }
