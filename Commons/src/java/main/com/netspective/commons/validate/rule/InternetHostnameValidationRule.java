...
/**
 * $Id: InternetHostnameValidationRule.java,v 1.1 2004-03-17 17:16:18 shahbaz.javeed Exp $
 */
...
public class InternetHostnameValidationRule extends BasicValidationRule
{
    private String invalidHostnameMessage = "{0} is not a valid hostname";

    public InternetHostnameValidationRule ()
    {
    }

    public InternetHostnameValidationRule(ValueSource caption)
    {
        super(caption);
    }
