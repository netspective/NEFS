...
public class TemplateText extends TemplateNode
{
    ...
    private boolean textExpressionsCounted;
    private boolean hasTextExpressions;
    private String text;

    public TemplateText(TemplateElement parentElement, String text)
    {
    ...
    protected void apply(TemplateApplyContext ac) throws SAXException
    {
        ...
        if(!contentHandler.isInIgnoreNode() && ac.isAllowReplaceExpressions() && isAllowReplaceExpressions())
        {
            ...
            if(hasTextExpressions)
            {
                ...
                contentHandler.text(activeEntry.evaluateTemplateTextExpressions(ac, text));
            }
            else
