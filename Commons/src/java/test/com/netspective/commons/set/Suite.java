...
public class Suite
{
    public static Test suite()
    {
        ...
        suite.addTest(new TestSuite(BinaryTest.class));
        suite.addTest(new TestSuite(CardinalTest.class));
        suite.addTest(new TestSuite(UnaryTest.class));
        suite.addTest(new TestSuite(BinaryTest.class));
        suite.addTest(new TestSuite(RelationTest.class));
        suite.addTest(new TestSuite(MemberTest.class));
