...
/**
 * $Id: BasicInputValidator.java,v 1.1 2003-03-13 18:37:22 shahid.shah Exp $
 */
...
public class BasicInputValidator extends BasicValidator implements InputValidator
{
    private List segments = new ArrayList();
    private Locator locator;

    public BasicInputValidator(InterchangeFormat format)
    {
        super(format);
    }
