...
import com.netspective.junxion.edi.format.igml.attributes.SegmentType;
...
public class Segment implements TextContainer
{
    private String id;
    private boolean ignoreBaseStructure;
    private SegmentType type;
    private TextList texts = new TextList();
    private DataElements dataElements = new DataElements();
