...
/**
 * $Id: DataElements.java,v 1.1 2003-03-13 18:37:20 shahid.shah Exp $
 */
...
public class DataElements
{
    ...
    private List compositesRefs = new ArrayList();
    ...
    public void addCompositeRef(CompositeRef compositeRef)
    {
        compositesRefs.add(compositeRef);
    }

    public List getCompositesRefs()
    {
        return compositesRefs;
    }

    public void setCompositesRefs(List compositesRefs)
    {
        this.compositesRefs = compositesRefs;
    }
}
