...
/**
 * $Id: NonValidatingFormat.java,v 1.1 2003-03-13 18:37:20 shahid.shah Exp $
 */

package com.netspective.junxion.edi.format.basic;
...
public class NonValidatingFormat implements InterchangeFormat
{
    public InputValidator createInputValidator()
    {
        return new BasicInputValidator(this);
    }

    public OutputValidator createOutputValidator()
    {
        return null;
    }
}
