...
/**
 * $Id: SegmentDictionary.java,v 1.1 2003-03-13 18:37:20 shahid.shah Exp $
 */
...
public class SegmentDictionary
{
    ...
    private Map segmentsById = new HashMap();

    public SegmentDictionary()
    {
    }

    public void addDictSegment(Segment segment)
    {
    ...
    {
        return (Segment) segmentsById.get(segmentId);
    }
