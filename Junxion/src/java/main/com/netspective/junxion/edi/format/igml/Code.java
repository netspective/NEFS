...
/**
 * $Id: Code.java,v 1.1 2003-03-13 18:37:20 shahid.shah Exp $
 */

package com.netspective.junxion.edi.format.igml;

import com.netspective.junxion.edi.format.igml.attributes.CodePart;
import com.netspective.junxion.edi.format.igml.attributes.CodeUser;
...
public class Code implements TextContainer
{
    private String id;
    ...
    public void setPart(CodePart part)
    {
        this.part = part;
    }

    public CodeUser getUser()
    {
        return user;
    }

    public void setUser(CodeUser user)
    {
        this.user = user;
    }
