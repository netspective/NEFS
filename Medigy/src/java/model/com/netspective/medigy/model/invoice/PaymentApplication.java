...
public class PaymentApplication extends AbstractTopLevelEntity
{
    ...
    /**
     * PAYMENT APPLICATION provides for the many-to-many relationships that can exist between
     * the PAYMENT and INVOICE ITEM as well as between the PAYMENT and BILLING ACCOUNT.
     */
    ...
    protected void setPaymentApplicationId(final Long paymentApplicationId)
    {
    ...
    public void setAmountApplied(final Float amountApplied)
    {
    ...
    public void setInvoiceId(final Invoice invoiceId)
    {
