...
public class CommunicationEventRole extends AbstractTopLevelEntity
{
    ...
    @Column(name = "comm_event_role_id")
    public Long getCommunicationEventRoleId()
    {
        return communicationEventRoleId;
    }

    protected void setCommunicationEventRoleId(final Long communicationEventRoleId)
    {
    ...
    public void setType(final CommunicationEventRoleType type)
    {
        this.type = type;
    }
