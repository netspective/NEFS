...
import com.netspective.medigy.reference.custom.health.HealthCareVisitStatusType;
...
public class HealthCareVisitStatus extends AbstractTopLevelEntity
{
    ...
    public HealthCareVisitStatusType getType()
    {
        return type;
    }

    public void setType(final HealthCareVisitStatusType type)
    {
        this.type = type;
    }
}
