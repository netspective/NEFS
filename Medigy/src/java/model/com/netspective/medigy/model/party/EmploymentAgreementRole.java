...
{
    private EmploymentAgreementRoleType type;
    private Party party;
    private EmploymentAgreement agreement;
    private Long agreementRoleId;

    @Id(generate = GeneratorType.AUTO)
    public Long getAgreementRoleId()
    {
        return agreementRoleId;
    }

    protected void setAgreementRoleId(final Long agreementRoleId)
    {
        this.agreementRoleId = agreementRoleId;
    }

    @ManyToOne (targetEntity = "com.netspective.medigy.model.party.EmploymentAgreement")
    ...
    {
        this.type = (EmploymentAgreementRoleType) type;
    }
