...
public class PartyRelationshipType extends AbstractReferenceEntity
{
    public enum Cache implements CachedReferenceEntity
    {
        SUPLLIER_RELATIONSHIP("SR", "Supplier Relationship", ""),
        EMPLOYMENT("E", "Employment", ""),
        CUSTOMER_RELATIONSHIP("CR", "Customer Relationship", ""),
        PARTNERSHIP("P", "Partnership", ""),
        ORGANIZATION_ROLLUP("OR", "Organization Rollup", ""),
        ORGANIZATION_CONTACT_RELATIONSHIP("OCR", "Organization Contact Relationship", ""),
        DISTRIBUTION_CHANNEL_RELATIONSHIP("DCR", "Distribution Channel Relationship", "");
