...
public class PartyRelationshipStatusType extends AbstractReferenceEntity
{
    public enum Cache implements CachedReferenceEntity
    {
        ...
        private PartyRelationshipStatusType entity;
        ...
        public PartyRelationshipStatusType getEntity()
        {
            return entity;
        }
        ...
        {
            this.entity = (PartyRelationshipStatusType) entity;
        }
    }
}
