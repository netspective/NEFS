...
public class PartyFacilityRoleType extends AbstractReferenceEntity
{
    ...
    {
        USE_FACILITY("U", "Use Facility", ""),
        LEASE_FACILITY("L", "Lease Facility", ""),
        RENT_FACILITY("R", "Rent Facility", ""),
        OWN_FACILITY("O", "Own Facility", "");

        private final String code;
        private final String label;
        private final String description;
        private PartyFacilityRoleType entity;
        ...
        public PartyFacilityRoleType getEntity()
        {
            return entity;
        }
        ...
        {
            this.entity = (PartyFacilityRoleType) entity;
        }
    }
}
