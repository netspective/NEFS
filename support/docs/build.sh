...
#$Id: build.sh,v 1.1 2003-10-27 19:40:57 shahid.shah Exp $
...
$JAVACMD -classpath $NEFS_COMMONS_REDIST_LIB/ant.jar:$NEFS_COMMONS_REDIST_LIB/ant-optional.jar:$NEFS_COMMONS_REDIST_LIB/junit.jar:$NEFS_COMMONS_REDIST_LIB/clover.jar:$NEFS_COMMONS_REDIST_LIB/xml-apis.jar:$NEFS_COMMONS_REDIST_LIB/xerces.jar:$CLASSPATH org.apache.tools.ant.Main $1 $2 $3 $4 $5 $6 $7 $8 $9
